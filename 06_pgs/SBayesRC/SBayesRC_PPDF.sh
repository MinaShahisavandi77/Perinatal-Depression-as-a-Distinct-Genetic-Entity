...
ma_file="SBayesRC/COJO/ppd_f_sumstats_cojo.ma"     
...
out_prefix="SBayesRC/ppd_f/ppd_f_eur"         
...
Rscript -e "SBayesRC::sbayesrc(mafile='${out_prefix}_imp.ma', LDdir='$ld_folder', \
                  outPrefix='${out_prefix}_sbrc', annot='$annot',bTune= FALSE,
  thresh= 0.95, log2file=TRUE)"
